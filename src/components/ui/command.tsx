  ...
  return (
    <CommandPrimitive
      className={cn(
        ...
        'text-popover-foreground flex h-full w-full flex-col overflow-hidden rounded-[inherit] bg-transparent',
        className
      )}
      data-slot="command"
      {...props}
  ...
  return (
    <div
      className={cn(
        ...
        'after:bg-border after:pointer-events-none after:absolute after:inset-x-2 after:bottom-0 after:h-px',
        wrapperClassName
      )}
